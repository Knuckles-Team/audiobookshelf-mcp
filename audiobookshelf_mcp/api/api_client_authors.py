...
class ApiClientAuthors(ApiClientBase):
    ...
    def match_author_by_id(
        ...
        if q is not None:
            body["q"] = q
        return self.request(
            "POST", self._path("api", "authors", id, "match"), json=body
        )
