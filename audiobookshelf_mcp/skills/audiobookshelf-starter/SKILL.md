---
name: audiobookshelf-starter
description: >-
  Audiobookshelf API + MCP Server + A2A Server Use when working with Audiobookshelf MCP via this package's MCP
...
license: MIT
tags: [audiobookshelf-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Audiobookshelf MCP Starter Skill

Starter skill for the **Audiobookshelf MCP** package. Use the `mcp-client` universal
...
> Replace this with concrete, trigger-oriented capabilities for Audiobookshelf MCP
